    ...
    try {
        ...
        while (attempt < maxAttempts) {
            try {
                ...
                if (createData.originalImageUrl !== undefined && isMissingColumn('originalImageUrl')) {
                    delete createData.originalImageUrl;
                    columnRemoved = true;
                }
                if (
                    (createData.chromaKeyColor !== undefined || createData.chromaKeyTolerance !== undefined) &&
                    (isMissingColumn('chromaKeyColor') || isMissingColumn('chromaKeyTolerance'))
                ) {
                ...
                if (!columnRemoved || attempt >= maxAttempts) {
                    throw createError;
                }
            }
        }
        ...
        if (!frame) {
            throw new Error('Gagal membuat frame');
        }
