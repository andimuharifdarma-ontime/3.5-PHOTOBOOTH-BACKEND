...
export const REPORTS_ACCESS_ROLES = ['ADMIN', 'KARYAWAN', 'CLIENT'] as const;
export type ReportsAccessRole = (typeof REPORTS_ACCESS_ROLES)[number];

export function isReportsAccessRole(role: string | undefined): role is ReportsAccessRole {
  return REPORTS_ACCESS_ROLES.includes(role as ReportsAccessRole);
}
